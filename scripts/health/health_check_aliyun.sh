...
# 11. 关键服务端口监听
echo "【11. 关键服务端口监听】"
sshpass -p "$PASSWORD" ssh -o StrictHostKeyChecking=no "$SERVER" "netstat -tlnp 2>/dev/null | grep -E ':(80|443|9898|8088|8089|7777|8888|9999|5003|5555)' || ss -tlnp | grep -E ':(80|443|9898|8088|8089|7777|8888|9999|5003|5555)'"
echo ""
...
# 17. 服务响应测试
echo "【17. 服务响应测试】"
echo "测试 todify 1.0 (9898):"
curl -s -o /dev/null -w "HTTP状态码: %{http_code}, 响应时间: %{time_total}s\n" http://47.113.225.93:9898 || echo "连接失败"
echo "测试 todify2 (8088):"
curl -s -o /dev/null -w "HTTP状态码: %{http_code}, 响应时间: %{time_total}s\n" http://47.113.225.93:8088 || echo "连接失败"
echo "测试 todify3 (8089):"
curl -s -o /dev/null -w "HTTP状态码: %{http_code}, 响应时间: %{time_total}s\n" http://47.113.225.93:8089 || echo "连接失败"
echo "测试 AI画布 (7777):"
curl -s -o /dev/null -w "HTTP状态码: %{http_code}, 响应时间: %{time_total}s\n" http://47.113.225.93:7777 || echo "连接失败"
echo ""
